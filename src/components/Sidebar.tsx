...
export const Sidebar = ({ activeView, setView, isDarkMode, toggleDarkMode, isOpen, onClose }: SidebarProps) => {
    ...
    return (
        <>
            ...
            <aside className={cn(
                "fixed left-0 top-0 z-50 h-screen w-64 border-r border-violet-100 dark:border-brand-800 bg-white dark:bg-brand-900 flex flex-col overflow-hidden transition-all duration-300 transform",
